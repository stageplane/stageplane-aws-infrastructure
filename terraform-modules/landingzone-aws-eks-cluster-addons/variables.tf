...
variable "cluster_name" {
  description = "Cluster name targeted by the add-on installation stage."
  type        = string
}

variable "cluster_endpoint" {
  description = "Cluster endpoint targeted by provider configuration or post-create automation."
  type        = string
}
